<template>
    <div ref="modal" class="modal fade" :id="props.modalId" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <slot name="body" :validateForm="validate" :modalIsVisible="modalIsVisible">

                </slot>

                <div class="modal-footer">
                    <button ref="closeButton" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
