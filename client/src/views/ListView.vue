<template>
    <div class="list-group">
        ...
        <a :href="generateURL(list.id)" class="list-group-item list-group-item-action d-flex align-items-start "
            aria-current="true" v-for="list in lists" :key="list.id">
    ...
    <Modal :close-modal="closeModalEvent" modal-id="addList">
        ...
        <template v-slot:body="slotProps">
            <CreateListForm :validate-form="slotProps.validateForm" :modal-is-visible="slotProps.modalIsVisible"
                form-id="addList" @closeModal="(closeModal: boolean) => closeModalEvent = closeModal">
            </CreateListForm>
        </template>
    </Modal>
</template>
