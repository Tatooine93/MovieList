<template>
  <div class="list-group">
    <div class="list-group-item active d-flex align-items-center justify-content-between p-2 gap-4">
      <a href="/list" class="text-white link-underline link-underline-opacity-0"> &#60; Prev </a>
      <div>
    ...
    <a
      :href="generateURL(movie.id, movie.apiMovieId)"
  ...
  <Modal :close-modal="closeModalEvent" modal-id="addMovie">
    <template v-slot:title> Add Movie </template>
    <template v-slot:body="slotProps">
      <CreateMovieForm
        :validate-form="slotProps.validateForm"
        :modal-is-visible="slotProps.modalIsVisible"
